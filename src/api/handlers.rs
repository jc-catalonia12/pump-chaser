...
use crate::user_settings::{
    save_app_config, settings_file_path, settings_schema, user_settings_values,
};
...
pub async fn user_settings_put(
    ...
    match crate::settings_commit::commit_user_settings_patch(state.as_ref(), &patch).await {
