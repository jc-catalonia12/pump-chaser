    ...
    vec![
        ...
        SettingsSection {
            ...
            fields: vec![field_select(
                "trading.mode",
                "Trading mode",
                vec!["confluence", "pump", "scalp", "both", "all"],
                Some("confluence = zone confluence only"),
            )],
        },
        SettingsSection {
            id: "risk".into(),
            ...
            fields: vec![
                ...
                field_int("risk.max_leverage", "Max leverage", 1.0, 125.0, 1.0),
        ...
        SettingsSection {
            ...
            fields: vec![
                ...
                field_int("confluence.base_leverage", "Base leverage", 1.0, 50.0, 1.0),
                field_int("confluence.moderate_leverage", "Moderate leverage", 1.0, 75.0, 1.0),
                field_int("confluence.strong_leverage", "Strong leverage", 1.0, 125.0, 1.0),
